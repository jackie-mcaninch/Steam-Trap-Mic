...
//
// steam_trap_telemetry_t   - This is a telemetry packet we transmit to the gateway every time we wake up from our
...
void CRadio::transmit_telemetry()
{
    ...
    telemetry.version          = 1;
    telemetry.frequency        = (int)(System.hum * 100);
